...
```bash
sudo apt install -y git && git clone https://github.com/MaxRheinschmittSantos/iWT51 && sudo chmod -R 777 instalador_single_oficial && cd instalador_single_oficial && sudo chmod -R 775 atualizador_remoto.sh && sudo chmod -R 775 instalador_apioficial.sh && sudo ./instalador_single.sh
```
